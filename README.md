...
Please download the TheaterSystem.jar from lib folder and execute the following command from Terminal or Command Window. 
This requires Java installation on your computer.

```
java -cp TheaterSystem.jar com.mypackage.theatersystem.Theater
```
